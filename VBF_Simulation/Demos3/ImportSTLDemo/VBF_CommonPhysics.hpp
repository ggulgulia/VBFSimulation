...
namespace VBF{  
    ...
    class CommonPhysics{
        ...
        public:
            ...
            CommonPhysics(); //c1
            CommonPhysics(VBF::World* vbf_world, VBF::RigidBody* ground, std::vector<VBF::RigidBody*>& vbf_rbody_vect); //c2
            CommonPhysics(VBF::World* vbf_world, VBF::RigidBody* ground, VBF::RigidBody* vbf_rbody); //c3
            CommonPhysics(VBF::World* vbf_world); //c4
